<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/localhost/0420/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '/localhost/0420'. $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/localhost/0420/project/config/routes.php';
